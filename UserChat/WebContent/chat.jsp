		...
		function addChat(chatName, chatContent, chatTime) {
			if (chatName == '나') {
				$('#chatList').append('<div class="row">' + 
						...
						'<img class="media-object img-circle" style="width: 40px; height: 40px;" src="<%= fromProfile %>" alt="">' + 
						'</a>' + 
				...
				$('#chatList').append('<div class="row">' + 
						...
						'<div class="media">' + 
						'<a class="pull-left" href="#">' + 
						'<img class="media-object img-circle" style="width: 40px; height: 40px;" src="<%= toProfile %>" alt="">' + 
						'</a>' + 
						'<div class="media-body">' + 
						'<h4 class="media-heading">' + 
						chatName + 
